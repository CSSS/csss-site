...
Select GMAIL API  
![Select GMAIL API](screenshots/Select%20GMAIL%20API.png)  
Enable GMAIL API  
![Enable GMAIL API](screenshots/Enable%20GMAIL%20API.png)  
Create Credentials  
![Create Credentials](screenshots/Create%20Credentials.png)  
Creating client ID  
![Creating client ID](screenshots/Creating%20client%20ID.png)  
Configure Consent Screen  
![Configure Consent Screen](screenshots/Configure%20Consent%20Screen.png)  
Creating OAuth consent screen  
![Creating OAuth consent screen](screenshots/Creating%20OAuth%20consent%20screen.png)  
Selecting client ID Application Type  
![Selecting client ID Application Type](screenshots/Selecting%20client%20ID%20Application%20Type.png)  
Copy Client ID and client secret  
![Copy Client ID and client secret](screenshots/Copy%20Client%20ID%20and%20client%20secret.png)  
