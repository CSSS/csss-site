...
ssh csss@sfucsss.org \
    "find /home/csss/csss-site/csss-site/src -mindepth 1 ! -regex '.*migrations.*' -delete" \
    || true
ssh csss@sfucsss.org "rm /home/csss/csss-site/requirements.txt; rm /home/csss/deploy_changes.sh"
ssh csss@sfucsss.org "rm /home/csss/site_envs; rm /home/csss/setEnv.sh"
