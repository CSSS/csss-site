...
def events(request):
	...
	return render(request, 'documents/events.html', {'events': events, 'albums': albums, 'tab': 'documents'})
...
def album(request):
	...
	return render(request, 'documents/album.html', {'album': album, 'nextButtonLink':nextButtonLink, 'previousButtonLink': previousButtonLink, 'medias': medias, 'tab': 'documents'})
