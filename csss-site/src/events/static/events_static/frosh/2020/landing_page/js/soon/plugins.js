/*
 * QueryLoader js_v2 - A simple script to create a preloader for images
 *
    ...
    $.queryLoader2 = function(el, options){
        ...
        base.findImageInElement = function (element) {
            ...
            if (obj.css("background-image") != "none") {
                ...
                type = "background";
            } else if (typeof(obj.attr("src")) != "undefined" && element.nodeName.toLowerCase() == "images") {
                url = obj.attr("src");
            }
