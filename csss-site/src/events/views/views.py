...
def frosh_2015_v2(request):
    return render(request, 'events/frosh/2015_v2/index.html', create_main_context(request, TAB))


def frosh_2015_temp(request):
    return render(request, 'events/frosh/2015_temp_site/index.html', create_main_context(request, TAB))
