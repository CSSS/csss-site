...
<html>
<head>
<title>CSSS FroshWeek 2011</title>
...
<div class="header">
	...
	<div class="container">
		...
		<div class="sponsors">
			<p>Sponsored by:</p>
			<img src="assets/images/header_sponsors.png" alt="FroshWeek Sponsors" />
		</div>
...
<div class="content">
	...
	<h3><a name="CSSS"></a>Computing Science Student Society</h3>
		
		<p>
			<img src="assets/images/csss_logo.png" class="floatLeft"></img>
			<h3>FroshWeek Founders</h3>
			<p>
			The six day long welcoming activities at Simon Fraser known as FroshWeek have been held annually by the CSSS 
			for the past six years. Without the continued support from both its executive board and members alike, an event 
			as big as this could not of been successful. Going into its seventh year, the society is responsible for planning, 
	...
	<h3><a name="SFU"></a>Simon Fraser University</h3>
		
		<p>
			<img src="assets/images/sfu_logo.png" class="floatLeft"></img>
			<h3>Hosts</h3>
			<p>
	...
	<h3><a name="FAS"></a>Faculty of Applied Sciences</h3>
		
		<p>
			<img src="assets/images/fas_logo.png" class="floatLeft"></img>
	...
	<h3><a name="CS"></a>School of Computing Science</h3>
		
		<p>
			
			<img src="assets/images/cs_logo.png" class="floatLeft"></img>
			<h3>Gold Level School Sponsor</h3>
			<p>
	...
	<h3><a name="SFSS"></a>Simon Fraser Student Society</h3>
		
		<p>
			<img src="assets/images/sfss_logo.png" class="floatLeft"></img>
			<h3>Gold Level School Sponsor</h3>
			<p>
	...
	<h3><a name="Simba"></a>Simba Technologies</h3>
		
		<p>
			<img src="assets/images/simba_logo.png" class="floatLeft"></img>
	...
	<h3><a name="imo"></a>imo</h3>
		
		<p>
			<img src="assets/images/imo_logo.png" class="floatLeft"></img>
			<h3>Bronze Level Corporate Sponsor</h3>
			<p>
			This is the first year imo have been a FroshWeek sponsor. Without the help of the industry we would not 
			be able to create such a meaningful and memorable event. We would like to thank them for their interest in the CSSS 
			and we are looking forward to working with them again in the future.
			</p>
		</p>
...
<div class="footer">
	<div class="container">
		<p>&copy; Copyright 2011 - <a href="http://csss.cs.sfu.ca/">Computing Science Student Society</a></p>
	</div>
</div>
