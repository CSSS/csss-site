...
<p class="question"><a name="faq_1">What's the difference between FroshWeek and </a><a href="http://www.sfu.ca/studentlife/orientation/index.html">Discover SFU Orientation</a>?</p>
...
<p class="question"><a name="faq_2">Do I need to attend all the events in the schedule I have classes that conflicts with them?</a></p>
...
<p class="question"><a name="faq_3">How much does FroshWeek cost?</a></p>

	<p>It's free!</p>

<p class="question"><a name="faq_4">I am a mature student or am already very familiar with campus and services offered. Do I still need to go?</a></p>
...
<p class="question"><a name="faq_5">What is the best way to get more information about FroshWeek?</a></p>
...
<p class="question"><a name="faq_6">I am unable to make an event. Can events be missed, entered late, or left early?</a></p>
...
<p class="question"><a name="faq_7">I have a lab/tutorial during one of the events.</a></p>
...
<p class="question"><a name="faq_8">I am located at the Surrey campus, can I still attend FroshWeek?</a></p>
	...
	in downtown Vancouver. Check out the <a href="http://www.csssfroshweek.ca/schedule.php">schedule</a> for more details on event locations and times.</p>
