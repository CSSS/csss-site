...
from resource_management.views.resource_views import validate_google_workspace_shared_team_drive_for_public_gallery
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        logger = Loggers.get_logger(logger_name=GOOGLE_WORKSPACE_SHARED_TEAM_DRIVE_PUBLIC_GALLERY_SERVICE_NAME)
        logger.info(options)
        ...
        Loggers.remove_logger(GOOGLE_WORKSPACE_SHARED_TEAM_DRIVE_PUBLIC_GALLERY_SERVICE_NAME)
