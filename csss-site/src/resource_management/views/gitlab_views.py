...
from resource_management.views.current_officer_list import create_current_officer_list
...
def create_gitlab_perms():
    ...
    """
    sfuids = [officer.sfuid.lower() for officer in create_current_officer_list()]
    gitlab_perms = []
    for item in sfuids:
