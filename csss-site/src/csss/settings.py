...
ANNOUNCEMENT_DISCORD_CHANNEL_ID = env_getter('ANNOUNCEMENT_DISCORD_CHANNEL_ID')
...
print(f"[settings.py] ANNOUNCEMENT_DISCORD_CHANNEL_ID={ANNOUNCEMENT_DISCORD_CHANNEL_ID}")
