...
def _get_sfuids_for_specified_position_in_specified_terms(
    ...
    if unprocessed_officers is None:
        unprocessed_officers = [
            unprocessed_officer.sfu_computing_id
            for unprocessed_officer in UnProcessedOfficer.objects.all()
        ]
    else:
        unprocessed_officers = [unprocessed_officer.sfu_computing_id for unprocessed_officer in unprocessed_officers]
    if officers is None:
