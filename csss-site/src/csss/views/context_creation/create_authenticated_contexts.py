...
def create_context_for_checking_google_drive_nags(request, tab=None):
    """
    Create the context for the page that displays the number of nags
...
def create_context_for_displaying_errors(request, tab=None):
    """
    Create the context for the pages where the user can view the current errors
