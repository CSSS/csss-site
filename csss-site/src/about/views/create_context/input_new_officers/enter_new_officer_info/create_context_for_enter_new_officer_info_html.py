...
from about.views.Constants import UNPROCESSED_OFFICER_NAME__KEY, UNPROCESSED_OFFICER_ANNOUNCEMENT_EMAILS__KEY, \
    ...
    UNPROCESSED_OFFICER_PHONE_NUMBER_KEY, UNPROCESSED_OFFICER_GITHUB_USERNAME__KEY, UNPROCESSED_OFFICER_COURSE_1__KEY, \
...
def create_context_for_enter_new_officer_info_html(context, username, officer_emaillist_and_position_mappings,
    ...
    context.update({
        ...
        INPUT_UNPROCESSED_OFFICER_GMAIL_VERIFICATION_CODE__NAME: UNPROCESSED_OFFICER_GMAIL_VERIFICATION_CODE__HTML_VALUE,
    ...
    if officer_info is not None:
        ...
        officer_announcement_emails = officer_info.get(UNPROCESSED_OFFICER_ANNOUNCEMENT_EMAILS__KEY, officer_announcement_emails)
