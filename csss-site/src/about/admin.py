...
class OfficerAdmin(admin.ModelAdmin):
    list_display = (
        'full_name', 'elected_term', 'discord_id', 'position_index', 'position_name', 'start_date',
        'sfu_computing_id', 'sfu_email_alias', 'phone_number', 'github_username', 'gmail',
...
class UnProcessedOfficerAdmin(admin.ModelAdmin):
    list_display = (
...
admin.site.register(UnProcessedOfficer, UnProcessedOfficerAdmin)
