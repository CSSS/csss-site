...
from elections.views.Constants import INPUT_DATE__NAME, ELECTION_JSON_KEY__DATE, INPUT_DATE__VALUE, DATE_FORMAT, \
    ...
    ELECTION_JSON_KEY__ELECTION_TYPE, CURRENT_ELECTION_TYPES, SELECTED_ELECTION_TYPE__HTML_NAME, CURRENT_WEBSURVEY_LINK, \
    INPUT_WEBSURVEY__NAME, ELECTION_JSON_KEY__WEBSURVEY, SAVE_NEW_JSON_ELECTION__BUTTON_ID, \
