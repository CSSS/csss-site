...
from elections.views.Constants import FINAL_NOMINEE_HTML__NAME, SAVE_NEW_NOMINEE__BUTTON_ID, \
    ...
    INPUT_NOMINEE_FACEBOOK__NAME, INPUT_NOMINEE_LINKEDIN__NAME, \
    INPUT_NOMINEE_EMAIL__NAME, INPUT_NOMINEE_DISCORD__NAME, CREATE_NEW_NOMINEE__HTML_NAME, \
...
from elections.views.ElectionModelConstants import ELECTION_JSON_KEY__NOMINEE, ELECTION_JSON_KEY__NOM_NAME, \
    ...
    ELECTION_JSON_KEY__NOM_DISCORD, ELECTION_JSON_KEY__NOM_POSITION_AND_SPEECH_PAIRINGS, \
