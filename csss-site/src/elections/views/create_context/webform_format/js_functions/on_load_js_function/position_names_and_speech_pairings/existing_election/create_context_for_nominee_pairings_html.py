...
from elections.views.create_context.webform_format.create_context_for_position_names_and_speech_pairing_html import \
...
def create_context_for_nominee_pairings_html(context, nominee_obj=None):
    if nominee_obj is not None:
        context_from_position_names_and_speech_pairing_html, context[DRAFT_NOMINEE_HTML__NAME][ELECTION_JSON_KEY__NOM_POSITION_AND_SPEECH_PAIRINGS] = \
            create_context_for_position_names_and_speech_pairing_html(nominee_obj_position_and_speech_pairing=nominee_obj[speech_pairing])
