...
def create_context_for_update_election__webform_html(
        ...
        new_webform_election=False, include_id_for_nominee=True, draft_or_finalized_nominee_to_display=True,
        nominees_info=None, election=None, get_existing_election_webform=False,
    ...
    create_context_for_form__webform_html(
        ...
        election_end_date=election_end_date,
