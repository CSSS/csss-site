...
def create_context_for_create_election__webform_html(
    context, error_messages=None, election_dict=None, election_date=None, election_time=None,
    election_end_date=None, election_type=None, websurvey_link=None, webform_election=True,
    new_webform_election=True, include_id_for_nominee=False, draft_or_finalized_nominee_to_display=False,
    nominees_info=None, create_or_update_webform_election=False
):
    """
    ...
    if election_dict is not None:
        ...
        if election_end_date is None and ELECTION_JSON_KEY__END_DATE in election_dict:
    ...
    create_context_for_form__webform_html(
        ...
        election_end_date=election_end_date, election_type=election_type, websurvey_link=websurvey_link,
