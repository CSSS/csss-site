...
from elections.views.Constants import SAVED_NOMINEE_LINKS, NEW_NOMINEE_SFUIDS_FOR_NOMINEE_LINKS
...
def transform_election_nominee_links_webform_to_json(request):
    ...
    if NEW_NOMINEE_SFUIDS_FOR_NOMINEE_LINKS in election_dict:
        new_nominee_dict[NEW_NOMINEE_SFUIDS_FOR_NOMINEE_LINKS] = election_dict[NEW_NOMINEE_SFUIDS_FOR_NOMINEE_LINKS]
