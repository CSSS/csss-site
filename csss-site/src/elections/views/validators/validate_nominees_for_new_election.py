    ...
    for nominee in nominees:
        if not all_relevant_nominee_keys_exist(nominee):
            return False, f"It seems that one of the nominees is missing one of the following fields:" \
                          ...
                          f"{ELECTION_JSON_KEY__NOM_DISCORD_ID}"
...
def all_relevant_nominee_keys_exist(nominee):
    return ELECTION_JSON_KEY__NOM_NAME in nominee and ELECTION_JSON_KEY__NOM_SFUID in nominee \
           ...
           and ELECTION_JSON_KEY__NOM_EMAIL in nominee and ELECTION_JSON_KEY__NOM_DISCORD_ID in nominee \
